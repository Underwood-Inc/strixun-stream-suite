...
- [SUCCESS] Proper dependency hoisting
- [SUCCESS] Workspace-aware build commands
- [SUCCESS] Automatic builds via `prebuild` scripts
- [SUCCESS] Efficient dependency management
...
- `react`, `react-dom` [EMOJI] Hoisted for React projects
- `svelte` [EMOJI] Hoisted for Svelte projects
- `vite`, `typescript` [EMOJI] Hoisted for all projects
- `@vitejs/plugin-react`, `@sveltejs/vite-plugin-svelte` [EMOJI] Hoisted
