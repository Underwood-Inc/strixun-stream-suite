...
<div class="page install-page" use:stagger={{ preset: 'fadeIn', stagger: 80, config: { duration: 300 } }}>
  <div class="card">
    <h3>[EMOJI] Installation Wizard</h3>
    ...
    <div id="installStep1" class="install-step active">
      ...
      <div class="url-box">
        ...
        <button on:click={handleDetectSourcePath}>[SEARCH] Detect</button>
      </div>
      ...
      <div class="url-box">
        ...
        <button on:click={handleBrowseTargetPath}>[FOLDER] Browse</button>
        <button on:click={handleDetectOBSPath}>[SEARCH] Auto-Detect</button>
      </div>
    ...
    <div id="installStep2" class="install-step">
      ...
      <div class="row" style="margin-top:12px">
        <button on:click={() => handleGoToInstallStep(1)}>[EMOJI] Back</button>
    ...
    <div id="installStep3" class="install-step">
      ...
      <div class="row" style="margin-top:12px">
        <button on:click={() => handleGoToInstallStep(2)}>[EMOJI] Back</button>
    ...
    <div id="installStep4" class="install-step">
      ...
      <div class="row" style="margin-top:12px">
        <button on:click={() => handleGoToInstallStep(3)}>[EMOJI] Back</button>
