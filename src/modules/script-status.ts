  ...
  if (isConnected) {
    ...
    container.innerHTML = `
      ...
      <p class="hint" style="margin-top:4px">
        <button onclick="window.showPage?.('install')" class="btn-link">[EMOJI] Install Scripts</button> if you haven't already
      </p>
    `;
  }
}
  ...
  if (!isConnected) {
    ...
    notice.innerHTML = `
      ...
      <div class="feature-notice__text">
        ...
        <button onclick="window.showPage?.('setup')" class="btn-link">Go to Setup [EMOJI]</button>
      </div>
    `;
    ...
    notice.innerHTML = `
      ...
      <div class="feature-notice__text">
        ...
        <button onclick="window.showPage?.('install')" class="btn-link">Go to Installer [EMOJI]</button>
      </div>
    `;
    container.insertBefore(notice, container.firstChild);
  }
