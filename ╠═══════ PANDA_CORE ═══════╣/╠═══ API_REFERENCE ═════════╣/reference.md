...
The control panel communicates with OBS via WebSocket (not HTTP API). This is documented separately in the [Technical Architecture](./TECHNICAL_ARCHITECTURE.md) document.
