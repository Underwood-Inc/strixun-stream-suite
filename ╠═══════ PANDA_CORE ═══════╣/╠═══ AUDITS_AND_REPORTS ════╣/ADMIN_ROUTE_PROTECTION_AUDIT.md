...
- `POST /admin/approvals/:customerId` - Approve user (super-admin)
- `DELETE /admin/approvals/:customerId` - Revoke user permission (super-admin)
...
- `GET /admin/users/:customerId` - Get user details (super-admin)
- `PUT /admin/users/:customerId` - Update user (super-admin)
- `GET /admin/users/:customerId/mods` - Get user's mods (super-admin)
