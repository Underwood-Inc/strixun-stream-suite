...
function createDevVars(filePath, content) {
  if (existsSync(filePath)) {
    console.log(`ℹ  ${filePath} already exists, skipping...`);
    return;
  }
 ...
 */
function main() {
  console.log('🚀 Setting up cloud IDE environment files...\n');
...
`);
  ...
  console.log('\n🚀 You can now run: pnpm dev:all');
  console.log('\n💡 OTP codes will be intercepted and printed to console (no emails sent)');
}
