 ...
 */
async function main() {
  console.log('[INFO] Starting documentation migration to wiki...\n');
  console.log('[INFO] This will move ALL documentation files to the wiki.\n');
  ...
  try {
    ...
    console.log('[INFO] Finding markdown files...');
    const allFiles = [];
    ...
    console.log(`\n[INFO] Processing ${allFiles.length} files...\n`);
    ...
    console.log(`\n[INFO] Copied ${copied} files to wiki\n`);
    ...
    if (success) {
      ...
      console.log(`[INFO] View your wiki at: https://github.com/${REPO_OWNER}/${REPO_NAME}/wiki`);
      console.log(`\n[INFO] Next steps:`);
