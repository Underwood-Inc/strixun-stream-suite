 ...
 */
export function initializeServiceTypes() {
    ...
    registry.register('customer', {
        ...
        metrics: {
            isActive: {
                required: false,
                compute: (data) => data.status === 'active',
            },
            isPremium: {
                required: false,
                compute: (data) => ['premium', 'enterprise'].includes(data.plan),
            },
        },
    });
    ...
    registry.register('room', {
        ...
        metrics: {
            participantCount: {
                required: false,
                compute: (data) => data.participants?.length || 0,
            },
            isFull: {
                required: false,
                compute: (data) => {
