  ...
  <g transform="translate(${thumbnailX + thumbnailSize + padding}, ${padding})">
    ...
    <g transform="translate(0, 280)">
      ...
      <g transform="translate(320, 0)">
        <text x="0" y="16" fill="${textSecondary}" font-size="20" font-weight="500" font-family="system-ui, -apple-system, sans-serif">[EMOJI] ${mod.downloadCount.toLocaleString()} downloads</text>
      </g>
