...
export function getCorsHeaders(env: Env, request: Request, customer: Customer | null = null): CorsHeaders {
    ...
    return {
        ...
        'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline'; connect-src 'self' https://customer.idling.app https://auth.idling.app; img-src 'self' data: https:; font-src 'self' data:",
    };
}
