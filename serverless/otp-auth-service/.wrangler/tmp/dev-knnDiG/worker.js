...
// .wrangler/tmp/bundle-bftvIL/checked-fetch.js
        ...
        if (isDev) {
          return new Response(`
                        ...
                        <head>
                            ...
                            <meta http-equiv="refresh" content="0;url=http://localhost:5174/dashboard">
                            <style>
                                body { 
                        ...
                        <body>
                            <div class="container">
                                ...
                                <p>If you're not redirected automatically, <a href="http://localhost:5174/dashboard">click here</a>.</p>
                                <p style="margin-top: 2rem; font-size: 0.875rem; color: var(--text-secondary);">
                                    Make sure the Vite dev server is running: <code style="background: #252017; padding: 0.25rem 0.5rem; border-radius: 4px;">pnpm dev:all</code>
                                </p>
                            </div>
                        </body>
                        </html>
...
// .wrangler/tmp/bundle-bftvIL/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-bftvIL/middleware-loader.entry.ts
