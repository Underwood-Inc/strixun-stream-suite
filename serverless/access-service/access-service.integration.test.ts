...
describe('Access Service Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        accessServiceUrl = await mf.ready.then(() => 'http://localhost:8791');
    });
    ...
    describe('Authentication Enforcement', () => {
        it('should reject unauthenticated GET requests', async () => {
            const response = await mf.dispatchFetch('http://localhost:8791/access/cust_123');
        ...
        it('should reject unauthenticated POST check-permission', async () => {
            const response = await mf.dispatchFetch('http://localhost:8791/access/check-permission', {
                method: 'POST',
                headers: {
        ...
        it('should reject unauthenticated POST check-quota', async () => {
            const response = await mf.dispatchFetch('http://localhost:8791/access/check-quota', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    describe('Rate Limiting', () => {
        ...
        it('should return retry-after header when rate limited', async () => {
            ...
            const response = await mf.dispatchFetch('http://localhost:8791/access/cust_rate_test', {
                headers: {
                    'X-Service-Key': SERVICE_API_KEY,
                },
            });
    ...
    describe('Permission Checks', () => {
        ...
        it('should check permission for customer with role', async () => {
            ...
            await mf.dispatchFetch('http://localhost:8791/access/cust_perm_test/roles', {
                method: 'PUT',
                headers: {
                    'X-Service-Key': SERVICE_API_KEY,
                    'Content-Type': 'application/json',
    ...
    describe('Quota Management', () => {
        ...
        it('should check quota availability', async () => {
            ...
            await mf.dispatchFetch('http://localhost:8791/access/cust_quota_test/roles', {
                method: 'PUT',
                headers: {
                    'X-Service-Key': SERVICE_API_KEY,
                    'Content-Type': 'application/json',
        ...
        it('should increment quota usage', async () => {
            // Assign role
            await mf.dispatchFetch('http://localhost:8791/access/cust_quota_inc/roles', {
                method: 'PUT',
                headers: {
                    'X-Service-Key': SERVICE_API_KEY,
                    'Content-Type': 'application/json',
            ...
            // Increment quota
            const response = await mf.dispatchFetch('http://localhost:8791/access/cust_quota_inc/quotas/increment', {
                method: 'POST',
                headers: {
                    'X-Service-Key': SERVICE_API_KEY,
                    'Content-Type': 'application/json',
    ...
    describe('Health Check', () => {
        it('should return healthy status', async () => {
            const response = await mf.dispatchFetch('http://localhost:8791/health');
    ...
    describe('CORS', () => {
        it('should handle OPTIONS preflight', async () => {
            const response = await mf.dispatchFetch('http://localhost:8791/access/test', {
                method: 'OPTIONS',
            });
    ...
    describe('End-to-End Access Control Flow', () => {
        it('should complete full access control workflow', async () => {
            ...
            const authResponse = await mf.dispatchFetch(`http://localhost:8791/access/${customerId}`, {
                headers: {
                    'X-Service-Key': SERVICE_API_KEY,
                },
            });
            ...
            // 4. Check permission
            const permResponse = await mf.dispatchFetch('http://localhost:8791/access/check-permission', {
                method: 'POST',
                headers: {
                    'X-Service-Key': SERVICE_API_KEY,
                    'Content-Type': 'application/json',
            ...
            // 5. Check quota
            const quotaResponse = await mf.dispatchFetch('http://localhost:8791/access/check-quota', {
                method: 'POST',
                headers: {
                    'X-Service-Key': SERVICE_API_KEY,
                    'Content-Type': 'application/json',
            ...
            // 6. Increment quota
            await mf.dispatchFetch(`http://localhost:8791/access/${customerId}/quotas/increment`, {
                method: 'POST',
                headers: {
                    'X-Service-Key': SERVICE_API_KEY,
                    'Content-Type': 'application/json',
            ...
            const finalAuth = await mf.dispatchFetch(`http://localhost:8791/access/${customerId}`, {
                headers: {
                    'X-Service-Key': SERVICE_API_KEY,
                },
            });
