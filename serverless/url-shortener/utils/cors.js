...
export function getCorsHeaders(env, request) {
  ...
  return {
      ...
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline'; connect-src 'self' https://customer-api.idling.app https://auth.idling.app; img-src 'self' data: https:; font-src 'self' data:",
  };
}
