...
export function getCorsHeaders(env: Env, request: Request): Record<string, string> {
    ...
    headers.set('Content-Security-Policy', "default-src 'self'; script-src 'self' 'unsafe-inline' https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline'");
