    ...
    if (scriptStatus.connected) {
        ...
        container.innerHTML = `
            <div class="script-status-grid">
                ...
                <div class="script-status-item installed">
                    <span class="script-status-item__icon">[SYNC]</span>
                    <span class="script-status-item__name">Source Swap</span>
                    <span class="script-status-item__badge">Ready</span>
                </div>
                <div class="script-status-item installed">
                    <span class="script-status-item__icon">[NOTE]</span>
                    <span class="script-status-item__name">Text Cycler</span>
                    <span class="script-status-item__badge">Ready</span>
                </div>
            </div>
            <p class="hint" style="margin-top:8px">
                [SUCCESS] All features available! Use the tabs above to access each feature.
            </p>
        `;
    } else {
        ...
        container.innerHTML = `
            ...
            <p class="hint" style="margin-top:4px">
                <button onclick="showPage('install')" class="btn-link">[EMOJI] Install Scripts</button> if you haven't already
            </p>
        `;
    }
}
    ...
    if (!scriptStatus.connected) {
        bannerHTML = `
            <div id="startupBanner" class="startup-banner">
                <span class="startup-banner__icon">[EMOJI]</span>
        ...
        bannerHTML = `
            <div id="startupBanner" class="startup-banner success">
                <span class="startup-banner__icon">[SUCCESS]</span>
                <div class="startup-banner__content">
    ...
    if (!scriptStatus.connected) {
        ...
        notice.innerHTML = `
            ...
            <div class="feature-notice__text">
                ...
                <button onclick="showPage('setup')" class="btn-link">Go to Setup [EMOJI]</button>
            </div>
        `;
        ...
        notice.innerHTML = `
            <div class="feature-notice__title">[EMOJI] Script Required: ${scriptName}</div>
            <div class="feature-notice__text">
                This feature requires the ${scriptName} Lua script. 
                <button onclick="showPage('install')" class="btn-link">Go to Installer [EMOJI]</button>
            </div>
        `;
        container.insertBefore(notice, container.firstChild);
    }
