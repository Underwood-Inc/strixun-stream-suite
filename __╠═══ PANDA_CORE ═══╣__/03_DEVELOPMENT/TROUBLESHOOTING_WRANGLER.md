...
5. **Check ports**: Ensure ports aren't in use (see [WORKER_PORT_MAPPING.md](../03_DEVELOPMENT/WORKER_PORT_MAPPING.md))

## Prevention

- Always use `--port` flag in package.json dev scripts (see [WORKER_PORT_MAPPING.md](../03_DEVELOPMENT/WORKER_PORT_MAPPING.md))
