...
This document audits test files to ensure they use development URLs, not production URLs.
...
### ⚠️ Production URLs in Code (Not Tests)
...
- [E2E_TESTING_GUIDE.md](../08_TESTING/E2E_TESTING_GUIDE.md) - E2E testing guide
- [DEVELOPMENT_DEPLOYMENT_SETUP.md](../04_DEPLOYMENT/DEVELOPMENT_DEPLOYMENT_SETUP.md) - Development deployment setup
