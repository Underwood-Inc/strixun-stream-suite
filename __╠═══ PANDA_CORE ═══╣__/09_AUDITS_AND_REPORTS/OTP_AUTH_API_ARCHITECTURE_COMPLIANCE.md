...
2. [WARNING] **TODO:** Update `PUT /admin/customers/me` to include `id` and `customerId`
3. [WARNING] **TODO:** Update all other admin handlers
4. [WARNING] **TODO:** Document pattern for future handlers
5. [WARNING] **TODO:** Add validation to ensure root config fields are always present
