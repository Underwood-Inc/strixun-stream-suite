...
> **Complete audit of all secrets and environment variables for Mods API**
...
### 2. `ALLOWED_EMAILS` ⚠️ **REQUIRED** (NEW)
...
### 3. `ALLOWED_ORIGINS` ⚠️ **RECOMMENDED**
...
### 5. `FILE_INTEGRITY_KEYPHRASE` ⚠️ **REQUIRED**
- **Purpose:** Secret keyphrase for HMAC-SHA256 file integrity signatures
- **Set via:** `wrangler secret put FILE_INTEGRITY_KEYPHRASE`
- **Status:** ✅ Required for file integrity system
- **See:** [Mods API Environment Setup](../07_SERVICES/MODS_API_ENVIRONMENT_SETUP.md) for details
...
5. **FILE_INTEGRITY_KEYPHRASE**: Required for file integrity verification. Never expose to clients.
