...
⚠ **More Network Requests** - Every API call goes to network  
⚠ **Slower Offline** - No offline fallback for API calls  
⚠ **Higher Bandwidth** - No cache means more data transfer  
