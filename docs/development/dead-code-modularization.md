...
- `serverless/otp-auth-service/worker.js`: **25 lines** [SUCCESS] (already modularized)
...
- `serverless/otp-auth-service/utils/cors.js` - [SUCCESS] (already extracted)
...
1. **Twitch API** [EMOJI] `serverless/handlers/twitch.js` [SUCCESS] (created)
   - `handleClips()`
   - `handleFollowing()`
   - `handleGame()`
   - `handleUser()`
...
2. **Cloud Storage** [EMOJI] `serverless/handlers/cloud-storage.js`
   - `handleCloudSave()`
   - `handleCloudLoad()`
   - `handleCloudList()`
   - `handleCloudDelete()`
...
1. **Handlers** [EMOJI] `serverless/url-shortener/handlers/`
...
2. **Utils** [EMOJI] `serverless/url-shortener/utils/`
   - `verifyJWT()` [EMOJI] use shared or OTP auth service
   - `generateShortCode()`
   - `isValidUrl()`
   - `isValidShortCode()`
   - `getJWTSecret()`

3. **Services** [EMOJI] `serverless/url-shortener/services/`
...
1. **Handlers** [EMOJI] `serverless/chat-signaling/handlers/`
   - `handleCreateRoom()`
   - `handleJoinRoom()`
   - `handleSendOffer()`
   - `handleGetOffer()`
...
2. **Utils** [EMOJI] `serverless/chat-signaling/utils/`
   - `hashEmail()` [EMOJI] use shared
   - `verifyJWT()` [EMOJI] use shared or OTP auth service

3. **Services** [EMOJI] `serverless/chat-signaling/services/`
   - Room management
   - Signaling logic

## Implementation Order

1. [SUCCESS] Create shared CORS utility
2. [SUCCESS] Extract Twitch handlers
3. [EMOJI] Remove duplicate OTP auth from root worker
4. [EMOJI] Extract Cloud Storage handlers
5. [EMOJI] Extract Notes handlers
6. [EMOJI] Extract OBS handlers
7. [EMOJI] Extract Scrollbar CDN code
8. [EMOJI] Modularize URL Shortener
9. [EMOJI] Modularize Chat Signaling
10. [EMOJI] Create shared auth utilities
11. [EMOJI] Update all workers to use shared utilities
