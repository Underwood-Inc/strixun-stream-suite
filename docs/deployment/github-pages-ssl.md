...
1. Go to **GitHub Repository** [EMOJI] **Settings** [EMOJI] **Pages**
2. Under **Custom domain**, you should see `streamkit.idling.app`
3. Wait for DNS check to complete (yellow dot [EMOJI] green checkmark)
...
1. Go to **GitHub Repository** [EMOJI] **Settings** [EMOJI] **Pages**
2. Under **Enforce HTTPS**, check the box [SUCCESS]
3. Your site will now **only** be accessible via HTTPS

---

## [SEARCH] Verify DNS is Working
...
1. **CAA Records Blocking Let's Encrypt** (Most Likely Issue)
   ...
   - **Fix**: Go to **Cloudflare Dashboard** [EMOJI] **DNS** [EMOJI] **Records**
...
2. **Remove and Re-add Custom Domain** (Triggers SSL Provisioning)
   - Go to **GitHub Repository** [EMOJI] **Settings** [EMOJI] **Pages**
...
**Fix**:
1. Verify CNAME record exists: `streamkit` [EMOJI] `underwood-inc.github.io`
...
2. **Remove and Re-add Custom Domain**
   ...
   - **GitHub Repository** [EMOJI] **Settings** [EMOJI] **Pages** [EMOJI] **Remove** domain
   - Wait 1-2 minutes
   - Re-add `streamkit.idling.app`
...
**Fix**:
1. Verify CNAME record: `streamkit` [EMOJI] `underwood-inc.github.io`
...
Once SSL is working:
- [SUCCESS] Site accessible at `https://streamkit.idling.app`
- [SUCCESS] HTTPS enforcement enabled
- [SUCCESS] No browser security warnings
- [SUCCESS] All traffic encrypted

---

## [CONFIG] Troubleshooting Checklist

- [ ] CNAME record exists: `streamkit` [EMOJI] `underwood-inc.github.io`
