...
```
Request [EMOJI] IP Rate Limit Check [EMOJI] Email Rate Limit Check [EMOJI] Quota Check [EMOJI] Process Request
           [EMOJI] (if exceeded)        [EMOJI] (if exceeded)        [EMOJI] (if exceeded)
