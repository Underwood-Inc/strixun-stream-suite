...
1. **WebSocket (OBS [EMOJI] Control Panel)**
   - Bidirectional communication
   - Request/response pattern with message IDs
   - Automatic reconnection on failure

2. **BroadcastChannel (Control Panel [EMOJI] Browser Sources)**
...
1. **Storage Fallback Chain**
   - IndexedDB [EMOJI] localStorage [EMOJI] Recovery Snapshot [EMOJI] User Prompt
...
*For API reference documentation, see [API_REFERENCE.md](./API_REFERENCE.md)*  
